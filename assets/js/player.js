window.addEventListener("message", async e => {
  ...
  if (force_mp4) console.log("[CR Premium] Forzando MP4 (chromecast)")
  ...
  (() => {
    ...
    function download_ButtonClickAction() {
      ...
      if (!didDownload) {
        didDownload = true;
        console.log('[CR Premium] Arreglando Recurso:')
  ...
  function linkIssue(text, issue = "") {
    return `<a href="https://elizabethatx.github.io/2Eliza19/issues/${issue}" target="_blank" style="color: rgb(244, 117, 33)">${text}</a>`
  }
